...
A minimalist portfolio website showcasing graphics, design engineering, and creative technology work. Built with a focus on interaction design, physics-based animations, and clean typography.
...
- Technologies displayed: Swift, SwiftUI, Metal, Three.js, GLSL, WebGL, C++, Wasm, JavaScript, Combine, ARKit
### Project Showcase
...
├── solaris.html        # Solaris project writeup (technical deep-dive)
...
- Contact icons (Email, LinkedIn, GitHub, Are.na)
...
- Autoplaying, muted, looping video with poster frames
...
Graphics & Design Engineer + Creative Technologist  
